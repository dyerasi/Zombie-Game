//press f while game is going to stop calling move() with each tick
//can call move call by call by pressing any other key than r and f
//r resumes regular game play
